...
//Name: lavender2.ma
//Last modified: Fri, Jun 22, 2012 07:06:12 pm
//Codeset: UTF-8
requires maya "2012";
requires "RenderMan_for_Maya" "4.0.3";
requires "VmCityislands" "v0.1";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 7.9662675197727575 5.4644762372023843 26.812083372690036 ;
	setAttr ".r" -type "double3" -23.738352729599811 -358.99999999998937 1.4911121105328267e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".ovr" 1.3;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 17.511391107364595;
...
createNode VmIslandNode -n "VmIslandNode_node1" -p "transform1";
	addAttr -ci true -h true -sn "rman__torattr___preShapeScript" -ln "rman__torattr___preShapeScript" 
		-dt "string";
	setAttr -k off ".v";
	setAttr ".mR" 6;
	setAttr ".gM" 30;
	setAttr ".bW" 0.10000000149011612;
	setAttr ".gSL" 0.20000000298023224;
	setAttr ".nGS" 4;
	setAttr ".wS" 3.6234042644500732;
	setAttr ".bCol1" -type "float3" 0.079315975 0.06024 0.25099999 ;
	setAttr ".tCol1" -type "float3" 0.72348416 0.373732 0.80199999 ;
	setAttr ".bCol2" -type "float3" 0.12335176 0.085020013 0.54500002 ;
	setAttr ".tCol2" -type "float3" 0.76599997 0.15166801 0.68408912 ;
	setAttr ".ds" 4;
	setAttr ".rman__torattr___preShapeScript" -type "string" "rmanOutputExampleProcedural()";
createNode transform -n "directionalLight1";
	setAttr ".t" -type "double3" 6.6032775244101138 3.086315725629587 0.55993230148454387 ;
	setAttr ".r" -type "double3" 37.705428209939846 64.952097169735922 129.5030753352292 ;
...
createNode RenderMan -s -n "renderManGlobals";
	...
	addAttr -ci true -h true -sn "rman__toropt___impliedSSBakeMode" -ln "rman__toropt___impliedSSBakeMode" 
		-dt "string";
	...
	setAttr -s 14 ".p";
	setAttr ".rman__toropt___impliedSSBakeMode" -type "string" "SSDiffuse";
...
createNode script -n "reloadRmanPreshapeScript";
	setAttr ".b" -type "string" "source \"rmanOutputExampleProcedural.mel";
createNode RenderManShader -n "VmIslandNode_RmanShader";
	addAttr -ci true -uac -k true -sn "ambientColor" -ln "ambientColor" -at "float3" 
		-nc 3;
	addAttr -ci true -k true -sn "ambientColorr" -ln "ambientColorR" -at "float" -p "ambientColor";
	addAttr -ci true -k true -sn "ambientColorg" -ln "ambientColorG" -at "float" -p "ambientColor";
	addAttr -ci true -k true -sn "ambientColorb" -ln "ambientColorB" -at "float" -p "ambientColor";
	addAttr -ci true -k true -sn "diffuseCoeff" -ln "diffuseCoeff" -dv 0.80000001192092896 
		-smn 0 -smx 1 -at "float";
	addAttr -ci true -k true -sn "cosPower" -ln "cosPower" -dv 15 -smn 0 -smx 100 -at "float";
	addAttr -ci true -uac -k true -sn "incandescence" -ln "incandescence" -at "float3" 
		-nc 3;
	addAttr -ci true -k true -sn "incandescencer" -ln "incandescenceR" -at "float" -p "incandescence";
	addAttr -ci true -k true -sn "incandescenceg" -ln "incandescenceG" -at "float" -p "incandescence";
	addAttr -ci true -k true -sn "incandescenceb" -ln "incandescenceB" -at "float" -p "incandescence";
	addAttr -ci true -k true -sn "translucenceCoeff" -ln "translucenceCoeff" -smn 0 
		-smx 100 -at "float";
	...
	addAttr -ci true -k true -sn "specularColorb" -ln "specularColorB" -dv 1 -at "float" 
		-p "specularColor";
	addAttr -ci true -k true -sn "reflectivity" -ln "reflectivity" -dv 1 -smn 0 -smx 
		1 -at "float";
	addAttr -ci true -k true -sn "refractiveIndex" -ln "refractiveIndex" -dv 1 -smn 
		0 -smx 1 -at "float";
	addAttr -ci true -uac -k true -sn "refractedColor" -ln "refractedColor" -at "float3" 
		-nc 3;
	addAttr -ci true -k true -sn "refractedColorr" -ln "refractedColorR" -dv 1 -at "float" 
		-p "refractedColor";
	addAttr -ci true -k true -sn "refractedColorg" -ln "refractedColorG" -dv 1 -at "float" 
		-p "refractedColor";
	addAttr -ci true -k true -sn "refractedColorb" -ln "refractedColorB" -dv 1 -at "float" 
		-p "refractedColor";
	addAttr -ci true -k true -sn "glowIntensity" -ln "glowIntensity" -smn 0 -smx 100 
		-at "float";
	setAttr ".sn" -type "string" "mtorPhong.slo";
	setAttr ".si" -type "string" "color ambientColor -default {0  0  0}\nfloat diffuseCoeff -default {0.8}\nfloat cosPower -default {15}\ncolor incandescence -default {0  0  0}\nfloat translucenceCoeff -default {0}\ncolor specularColor -default {1  1  1}\nfloat reflectivity -default {1}\nfloat refractiveIndex -default {1}\ncolor refractedColor -default {1  1  1}\nfloat glowIntensity -default {0}\n";
	setAttr -k on ".ambientColor" -type "float3" 0.067414358 0.067414358 0.067414358 ;
	setAttr -k on ".diffuseCoeff" 0.32885906100273132;
	setAttr -k on ".cosPower" 18.791946411132812;
	setAttr -k on ".specularColor" -type "float3" 0.33707181 0.33707181 0.33707181 ;
createNode shadingEngine -n "VmIslandNode_RmanShaderSG";
	setAttr ".ro" yes;
...
createNode RenderManLight -n "RenderManLight1";
	addAttr -ci true -k true -sn "intensity" -ln "intensity" -dv 1 -smn 0 -smx 1 -at "float";
	addAttr -ci true -uac -k true -sn "lightcolor" -ln "lightcolor" -at "float3" -nc 
		3;
	addAttr -ci true -k true -sn "lightcolorr" -ln "lightcolorR" -dv 1 -at "float" -p "lightcolor";
	addAttr -ci true -k true -sn "lightcolorg" -ln "lightcolorG" -dv 1 -at "float" -p "lightcolor";
	addAttr -ci true -k true -sn "lightcolorb" -ln "lightcolorB" -dv 1 -at "float" -p "lightcolor";
	addAttr -ci true -k true -sn "decayRate" -ln "decayRate" -smn 0 -smx 100 -at "float";
	addAttr -ci true -k true -sn "shadowname" -ln "shadowname" -dt "string";
	addAttr -ci true -uac -k true -sn "shadowcolor" -ln "shadowcolor" -at "float3" -nc 
		3;
	addAttr -ci true -k true -sn "shadowcolorr" -ln "shadowcolorR" -at "float" -p "shadowcolor";
	addAttr -ci true -k true -sn "shadowcolorg" -ln "shadowcolorG" -at "float" -p "shadowcolor";
	addAttr -ci true -k true -sn "shadowcolorb" -ln "shadowcolorB" -at "float" -p "shadowcolor";
	addAttr -ci true -k true -sn "shadowblur" -ln "shadowblur" -smn 0 -smx 100 -at "float";
	addAttr -ci true -k true -sn "shadowsamples" -ln "shadowsamples" -dv 16 -smn 0 -smx 
		100 -at "float";
	addAttr -ci true -k true -sn "shadowbias" -ln "shadowbias" -smn 0 -smx 100 -at "float";
	addAttr -ci true -k true -sn "softtype" -ln "softtype" -smn 0 -smx 100 -at "float";
	addAttr -ci true -k true -sn "softsize" -ln "softsize" -dv 1 -smn 0 -smx 1 -at "float";
	addAttr -ci true -k true -sn "softbias" -ln "softbias" -smn 0 -smx 100 -at "float";
	setAttr ".sn" -type "string" "mtorDirectionalLight.slo";
	setAttr ".si" -type "string" "float intensity -default {1}\ncolor lightcolor -default {1  1  1}\nfloat decayRate -default {0}\nstring shadowname -default {}\ncolor shadowcolor -default {0  0  0}\nfloat shadowblur -default {0}\nfloat shadowsamples -default {16}\nfloat shadowbias -default {0}\nfloat softtype -default {0}\nfloat softsize -default {1}\nfloat softbias -default {0}\n";
	setAttr -k on ".intensity" 1.5;
	setAttr -k on ".shadowname" -type "string" "";
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "RenderManLight1.msg" "directionalLightShape1.rman__torattr___customLightShader"
		;
...
connectAttr "VmIslandNode_RmanShader.oc" "VmIslandNode_RmanShaderSG.ss";
connectAttr "VmIslandNode_node1.iog" "VmIslandNode_RmanShaderSG.dsm" -na;
...
connectAttr "RenderManLight1.msg" ":lightList1.l" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "directionalLight1.iog" ":defaultLightSet.dsm" -na;
connectAttr "RenderManLight1.msg" ":defaultLightSet.dnsm" -na;
// End of lavender2.ma
